...
public class RobotMap {
    ...
    public static DigitalInput elevatorelevatorSlowDownUp;
    public static DigitalInput elevatorelevatorSlowDownDown;
    ...
    public static boolean stepLimitSwitchIsPressed = false; 
    ...
    public static void init() {
        ...
        elevatorelevatorSlowDownUp = new DigitalInput(7);
        LiveWindow.addSensor("Elevator", "elevatorSlowDownUp", elevatorelevatorSlowDownUp);
        
        elevatorelevatorSlowDownDown = new DigitalInput(8);
        LiveWindow.addSensor("Elevator", "elevatorSlowDownDown", elevatorelevatorSlowDownDown);
        ...
        rollyGrabberrollyGrabberMotorOne = new Talon(7);
